...
# aws_subnet_ids is deprecated in provider v5; use aws_subnets instead
...
# to connect to the instance (separate from the inline policy below)
...
# -------------------------------------------------------------------
# Security group — no inbound HTTP; Jenkins accessed via SSM only
# -------------------------------------------------------------------
